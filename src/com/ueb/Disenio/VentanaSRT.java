...
import com.ueb.Algoritmos.SRT;

public class VentanaSRT extends JFrame implements ActionListener
{
	/**
	 * 
	 */
	...
	// ---------------------------------------------------------------------------------------------------
		...
		public static final String TITULO = "Algoritmo SRT";
		...
		public VentanaSRT(VentanaPrincipal pVentanaP)
		{
