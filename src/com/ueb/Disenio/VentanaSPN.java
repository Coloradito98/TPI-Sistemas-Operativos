...
import com.ueb.Algoritmos.SPN;


public class VentanaSPN extends JFrame implements ActionListener
{
	...
	// ---------------------------------------------------------------------------------------------------
		...
		public static final String TITULO = "Algoritmo SPN";
		...
		public VentanaSPN(VentanaPrincipal pVentanaP)
		{
...
//			}
		...
		private void ingresarDatosAleatorios()
		{
			...
			try
			{
				int rangoMinimo = Integer.parseInt( this.pedirDatoRango("Ingresar el valor minimo de tiempo de servicio de los procesos\nDebe estar en el rango de 1 - 100").trim() );
				...
				int rangoMaximo = Integer.parseInt( this.pedirDatoRango("Ingrese el valor maximo de tiempo de servicio de los procesos\nDebe estar en el rango de 1 - 100").trim() );
				...
				int demoraMaxima = Integer.parseInt( this.pedirDatoRango("Ingrese el valor maximo de tiempo de llegada de los procesos\nDebe estar en el rango de 0 - 100").trim() );
